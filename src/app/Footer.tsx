...
function IconBxlFacebookCircle(props: React.SVGProps<SVGSVGElement>) {
    return (
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
  ...
  function IconLogoPinterest(props: React.SVGProps<SVGSVGElement>) {
    return (
      <svg
        viewBox="0 0 512 512"
        fill="currentColor"
  ...
  function IconBxlTiktok(props: React.SVGProps<SVGSVGElement>) {
    return (
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
        ...
        <section className="first-footer-section">
            <div className="about-footer">
                ...
                <ul className='about-items list'>
                    <li><Link href="/">About logo</Link></li>
                    <li><Link href="/">Proffessional</Link></li>
                    <li><Link href="/">Careers</Link></li>
                    <li><Link href="/">Gift cards</Link></li>
                    <li><Link href="/">Sell on logo</Link></li>
